              ...
              <table className="min-w-full border border-gray-300">
                ...
                <tbody>
                  {currentItems.map((hotel) => (
                    <tr key={hotel.id} className="odd:bg-white even:bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2">{hotel.id}</td>
                      <td className="border border-gray-300 px-4 py-2">{hotel.email}</td>
                      <td className="border border-gray-300 px-4 py-2">{hotel.expiredDate}</td>
                      <td className="border border-gray-300 px-4 py-2">{hotel.createdDate}</td>
                      <td className="border border-gray-300 px-4 py-2">{hotel.group}</td>
